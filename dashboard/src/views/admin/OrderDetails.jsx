          ...
          <div className="flex flex-wrap mt-4">
            ...
            <div className="w-full lg:w-1/3">
              <div className="pr-4 text-gray-800">
                <div className="mb-4">
                  <h2 className="pb-2 font-semibold">Deliver To: Ilyas Gris</h2>
                  <p className="text-sm">
            ...
            <div className="w-full lg:w-2/3">
              <div className="pl-4">
                <div className="bg-[#f29f6747] p-6 rounded-md mb-4">
                  <div className="mb-4">
                    <h2 className="font-medium">Seller 1 Order:</h2>
                  ...
                  <div className="mb-4">
                    <h2 className="font-medium">Seller 2 Order:</h2>
                    <span className="text-sm">Pending</span>
                  </div>
                  <div className="flex gap-3 items-center">
                    <img
                ...
                <div className="bg-[#f29f6747] p-6 rounded-md">
                  <div className="mb-4">
                    <h2 className="font-medium">Seller 3 Order:</h2>
                    <span className="text-sm">Pending</span>
                  </div>
                  <div className="flex gap-3 items-center">
                    <img
